    ...
    <div id="amazingslider-wrapper-1" 
        ...
        <div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
            <ul class="amazingslider-slides" style="display:none;">
                <li><img src="images/p1.PNG" alt="p1" />
                </li>
                <li><img src="images/p2.PNG" alt="p2" />
                </li>
                <li><img src="images/p3.PNG" alt="p3" />
                </li>
                <li><img src="images/p4.PNG" alt="p4" />
                </li>
                <li><img src="images/p5.PNG" alt="p5" />
                </li>
                <li><img src="images/p6.PNG" alt="p6" />
                </li>
                <li><img src="images/p7.PNG" alt="p7" />
                </li>
            </ul>
            <ul class="amazingslider-thumbnails" style="display:none;">
                <li><img src="images/p1-tn.PNG" alt="p1" /></li>
                <li><img src="images/p2-tn.PNG" alt="p2" /></li>
                <li><img src="images/p3-tn.PNG" alt="p3" /></li>
                <li><img src="images/p4-tn.PNG" alt="p4" /></li>
                <li><img src="images/p5-tn.PNG" alt="p5" /></li>
                <li><img src="images/p6-tn.PNG" alt="p6" /></li>
                <li><img src="images/p7-tn.PNG" alt="p7" /></li>
            </ul>
